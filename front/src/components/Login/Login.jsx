            ...
            <div className="login-middle-cont">
                ...
                <form className="login-form" onSubmit={loginSubmit}>
                    <div className="display-flex-row-div" style={{marginBottom: "10px", padding: "15px", backgroundColor: "white", borderRadius: "10px", boxShadow: "0 2px 4px -2px rgba(24,39,75,.12), 0 4px 4px -2px rgba(24,39,75,.08)"}}>
                        ...
                        <input value={formData.nroDocumento} required={true} name="nroDocumento" onChange={handleChange} className="login-doc-input" type="text" placeholder="Nro. de documento" style={{flex: "1"}}></input>
                    </div>
                    <input type="password" value={formData.password} required={true} name="password" onChange={handleChange} className="login-password-input" placeholder="Ingresa tu contraseña"></input>
